...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 306.0, 128.0, 52.0 ],
					"text" : "the scripting name of this object is \"radians\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 286.0, 162.0, 60.0 ],
					"text" : "the name of the subpatch, two colons, and the name of the pattr or UI object you want to bind to"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 250.0, 128.0, 33.0 ],
					"text" : "the specified angle in degrees is equal to:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 402.0, 437.5, 33.0 ],
					"text" : "the use of pattr in this patch is rather contrived, but allows a demonstration of binding between objects in a subpatch and objects in the parent patch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.5, 16.0, 112.0, 33.0 ],
					"text" : "this patch converts degrees to radians"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 157.5, 219.0, 33.0 ],
					"text" : "view the contents of this patcher object to see the bindings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.5, 80.0, 208.0, 47.0 ],
					"text" : "pattr objects can bind to each other (or to user interface objects) even when one of them is in a subpatch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 286.0, 50.0, 20.0 ],
					"text" : "radians"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 138.0, 54.0, 20.0 ],
					"text" : "degrees"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 286.0, 72.0, 22.0 ],
					"varname" : "radians"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 48.0, 248.0, 112.0, 35.0 ],
					"restore" : [ 126 ],
...
,
					"text" : "pattr @bindto degtorad::degrees",
					"varname" : "u701001064"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 32.0, 80.0, 209.0, 22.0 ],
									"restore" : [ 2.19911475 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
...
,
									"text" : "pattr radians @bindto parent::radians",
									"varname" : "radians"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.0, 48.0, 135.0, 22.0 ],
									"text" : "expr $f1*6.283185/360."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 32.0, 16.0, 81.0, 22.0 ],
									"restore" : [ 126 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0,
										"parameter_mappable" : 0
...
,
					"patching_rect" : [ 261.0, 132.0, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 200.0, 43.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 48.0, 168.0, 35.0, 22.0 ],
					"text" : "t"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 48.0, 136.0, 40.0, 22.0 ],
					"varname" : "degrees"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 48.0, 80.0, 40.0, 40.0 ],
					"size" : 360.0
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 73.5, 228.0, 39.0, 228.0, 39.0, 74.0, 57.5, 74.0 ],
					"source" : [ "obj-7", 0 ]
				}
