...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 320.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 432.0, 219.0, 79.0, 22.0 ],
					"sig" : 0.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 473.5, 115.0, 69.0, 22.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 384.0, 115.0, 65.0, 22.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"tricolor" : [ 0.75, 0.75, 0.75, 1.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 306.5, 265.0, 32.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 256.0, 265.0, 35.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 63.0, 71.0, 20.0 ],
					"text" : "noisemaker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 272.0, 219.0, 66.0, 22.0 ],
					"text" : "-~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 116.0, 70.0, 20.0 ],
					"text" : "destination"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 384.0, 58.0, 19.0, 20.0 ],
					"text" : "L"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 467.0, 96.0, 82.0, 20.0 ],
					"text" : "pan time (ms)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 384.0, 149.0, 65.0, 22.0 ],
					"text" : "pack 0. 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 384.0, 75.0, 36.0, 24.0 ],
					"size" : 2.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 384.0, 179.0, 36.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 64.0, 205.0, 83.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 64.0, 79.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 64.0, 112.0, 69.0, 22.0 ],
					"text" : "metro 125"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 141.0, 54.0, 22.0 ],
					"text" : "1 5 0 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 64.0, 173.0, 36.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 128.0, 173.0, 47.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 272.0, 179.0, 47.0, 22.0 ],
					"text" : "sig~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.0, 24.0, 116.0, 24.0 ],
					"text" : "Linear Panning"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 56.0, 336.0, 240.0 ],
					"proportion" : 0.39,
					"rounded" : 16
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 393.5, 212.0, 441.5, 212.0 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 393.5, 253.0, 329.0, 253.0 ],
					"order" : 1,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 393.5, 212.0, 328.5, 212.0 ],
					"order" : 2,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 73.5, 257.0, 316.0, 257.0 ],
					"order" : 0,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 73.5, 257.0, 265.5, 257.0 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 316.0, 303.5, 291.5, 303.5 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 483.0, 145.0, 450.0, 145.0, 450.0, 145.0, 439.5, 145.0 ],
					"source" : [ "obj-22", 0 ]
				}
