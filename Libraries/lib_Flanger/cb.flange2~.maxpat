...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.0, 30.5, 269.0, 24.0 ],
					"text" : "Abstraction to flange an audio signal"
				}

			}
, 			{
				"box" : 				{
					"comment" : "(signal) flanged audio",
					"id" : "obj-69",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 424.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 720.0, 165.5, 96.0, 22.0 ],
					"text" : "maximum 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 816.0, 200.0, 49.0, 22.0 ],
					"text" : "t signal"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 112.0, 48.0, 46.0, 22.0 ],
									"text" : "sig~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 37.5, 217.0, 110.0, 20.0 ],
									"text" : "mixed audio signal"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 80.0, 192.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 80.0, 160.0, 115.0, 22.0 ],
									"text" : "+~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 176.0, 128.0, 32.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 80.0, 128.0, 51.0, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 112.0, 88.0, 32.5, 22.0 ],
									"text" : "-~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 250.0, 23.0, 69.0, 20.0 ],
									"text" : "xfade (0-1)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 146.0, 23.0, 85.0, 20.0 ],
									"text" : "audio signal 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 23.0, 85.0, 20.0 ],
									"text" : "audio signal 1"
								}
...
, 							{
								"box" : 								{
									"comment" : "(float/signal) xfade (0. to 1.)",
									"id" : "obj-6",
									"index" : 3,
									"maxclass" : "inlet",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 272.0, 39.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 281.5, 79.0, 135.0, 79.0 ],
									"order" : 1,
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 281.5, 114.0, 199.0, 114.0 ],
									"order" : 0,
									"source" : [ "obj-6", 0 ]
								}
...
,
					"patching_rect" : [ 352.0, 376.0, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 48.0, 80.0, 339.0, 22.0 ],
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 48.0, 216.0, 54.0, 22.0 ],
					"text" : "phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 16.0, 248.0, 51.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 416.0, 336.0, 51.0, 22.0 ],
					"text" : "tapout~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 96.0, 320.0, 51.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 560.0, 336.0, 35.0, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 560.0, 376.0, 93.0, 22.0 ],
					"text" : "clip~ -0.99 0.99"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 480.0, 296.0, 35.0, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 480.0, 336.0, 62.0, 22.0 ],
					"text" : "clip~ 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 216.0, 35.0, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 248.0, 66.0, 22.0 ],
					"text" : "clip~ -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 96.0, 352.0, 67.0, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 146.0, 59.0, 20.0 ],
					"text" : "feedback"
				}
...
, 			{
				"box" : 				{
					"comment" : "(float/signal) feedback (0. to 0.99)",
					"id" : "obj-34",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 416.0, 296.0, 44.0, 22.0 ],
					"text" : "tapin~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 448.0, 256.0, 35.0, 22.0 ],
					"text" : "* 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 48.0, 32.0, 209.0, 22.0 ],
					"text" : "patcherargs 1n 0. 0.5 0. @predelay 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.5, 137.5, 64.5, 33.0 ],
					"text" : "unused in this patch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 880.0, 236.0, 77.0, 22.0 ],
					"text" : "print flange~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 880.0, 160.0, 59.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 880.0, 200.0, 167.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 432.0, 120.0, 467.0, 22.0 ],
					"text" : "route done rate depth mix feedback predelay signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 235.0, 146.0, 29.0, 20.0 ],
					"text" : "mix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 146.0, 41.0, 20.0 ],
					"text" : "depth"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 146.0, 31.0, 20.0 ],
					"text" : "rate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.5, 16.0, 40.0, 20.0 ],
					"text" : "audio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 541.5, 424.0, 37.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					"comment" : "(float/signal) mix (dry/wet , 0. to 1.)",
					"id" : "obj-8",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 164.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "(float/signal) depth (0. to 1.)",
					"id" : "obj-6",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 164.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "(float/signal) rate (Hz or transport-related time)",
					"id" : "obj-4",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.0, 164.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.0, 32.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 569.5, 206.0, 137.5, 206.0 ],
					"source" : [ "obj-18", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 633.5, 273.0, 505.5, 273.0 ],
					"source" : [ "obj-18", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 697.5, 321.0, 585.5, 321.0 ],
					"source" : [ "obj-18", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 505.5, 199.0, 57.5, 199.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 761.5, 153.0, 729.5, 153.0 ],
					"source" : [ "obj-18", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 247.5, 69.0, 441.5, 69.0 ],
					"source" : [ "obj-26", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 457.5, 281.5, 425.5, 281.5 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-50", 1 ],
					"midpoints" : [ 326.5, 243.0, 585.5, 243.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 105.5, 384.0, 339.0, 384.0, 339.0, 324.0, 425.5, 324.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 86.5, 199.0, 57.5, 199.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 489.5, 372.0, 489.5, 372.0 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 425.5, 372.0, 425.5, 372.0 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 25.5, 278.0, 105.5, 278.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-45", 1 ],
					"midpoints" : [ 169.5, 206.0, 137.5, 206.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 1 ],
					"midpoints" : [ 217.5, 243.0, 505.5, 243.0 ],
					"source" : [ "obj-61", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-50", 1 ],
					"midpoints" : [ 297.5, 132.0, 411.0, 132.0, 411.0, 243.0, 585.5, 243.0 ],
					"source" : [ "obj-61", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 361.5, 416.5, 551.0, 416.5 ],
					"order" : 0,
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 825.5, 231.0, 426.0, 231.0, 426.0, 288.0, 425.5, 288.0 ],
					"order" : 0,
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 825.5, 231.0, 361.5, 231.0 ],
					"order" : 1,
					"source" : [ "obj-66", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 729.5, 243.0, 457.5, 243.0 ],
					"order" : 0,
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 729.5, 224.0, 189.0, 224.0, 189.0, 339.0, 153.5, 339.0 ],
					"order" : 1,
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 729.5, 224.0, 189.0, 224.0, 189.0, 306.0, 137.5, 306.0 ],
					"order" : 2,
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-48", 1 ],
					"midpoints" : [ 246.5, 243.0, 505.5, 243.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 551.0, 455.0, 673.0, 455.0, 673.0, 360.0, 672.0, 360.0, 672.0, 289.0, 425.5, 289.0 ],
					"source" : [ "obj-9", 0 ]
				}
