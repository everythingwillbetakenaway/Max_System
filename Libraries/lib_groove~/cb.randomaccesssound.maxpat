...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 32.0, 304.0, 34.0, 22.0 ],
					"text" : "pow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 32.0, 336.0, 33.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 472.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 112.0, 336.0, 66.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 32.0, 240.0, 42.0, 22.0 ],
					"text" : "* 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 32.0, 208.0, 38.0, 22.0 ],
					"text" : "- 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 32.0, 176.0, 75.0, 22.0 ],
					"text" : "random 201"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 424.0, 32.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 224.0, 240.0, 32.5, 22.0 ],
					"text" : "- 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 304.0, 87.0, 22.0 ],
					"text" : "1 10 1 $1 0 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 192.0, 272.0, 51.0, 22.0 ],
					"text" : "i 480"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.0, 336.0, 48.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 80.0, 96.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 16.0, 35.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 112.0, 304.0, 51.0, 22.0 ],
					"text" : "random"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 376.0, 128.0, 64.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 208.0, 80.0, 243.0, 22.0 ],
					"text" : "info~ randomaccesssound"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 112.0, 384.0, 168.0, 22.0 ],
					"text" : "groove~ randomaccesssound"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 64.0, 48.0, 163.0, 22.0 ],
					"text" : "buffer~ randomaccesssound"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 201.5, 376.0, 99.0, 376.0, 99.0, 417.0, 135.0, 417.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 137.5, 127.5, 233.5, 127.5 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 121.5, 457.5, 147.5, 457.5 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 41.5, 368.5, 121.5, 368.5 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 385.5, 200.5, 153.5, 200.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 89.5, 168.0, 201.5, 168.0 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 89.5, 168.0, 41.5, 168.0 ],
					"order" : 2,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 89.5, 168.0, 121.5, 168.0 ],
					"order" : 1,
					"source" : [ "obj-9", 0 ]
				}
