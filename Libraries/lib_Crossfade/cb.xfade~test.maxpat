...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.0, 24.0, 149.0, 20.0 ],
					"text" : "Try the xfade~ abstraction"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 24.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 56.0, 66.0, 22.0 ],
					"text" : "pack 0. 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 480.0, 88.0, 56.0, 22.0 ],
					"text" : "line~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 320.0, 152.0, 179.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 320.0, 120.0, 179.0, 22.0 ],
					"text" : "cb.xfade~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 400.0, 88.0, 68.0, 22.0 ],
					"text" : "cycle~ 784"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 320.0, 88.0, 68.0, 22.0 ],
					"text" : "cycle~ 880"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 216.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 152.0, 179.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 192.0, 88.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 32.0, 120.0, 179.0, 22.0 ],
					"text" : "cb.xfade~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 88.0, 68.0, 22.0 ],
					"text" : "cycle~ 465"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 32.0, 88.0, 68.0, 22.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 184.0, 291.5, 184.0 ],
					"order" : 0,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 198.0, 265.5, 198.0 ],
					"order" : 1,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 1 ],
					"midpoints" : [ 329.5, 184.0, 291.5, 184.0 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 329.5, 198.0, 265.5, 198.0 ],
					"order" : 1,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cb.xfade~.maxpat",
				"bootpath" : "~/Desktop/Max_System/Libraries/lib_Crossfade",
				"patcherrelativepath" : "../Desktop/Max_System/Libraries/lib_Crossfade",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
