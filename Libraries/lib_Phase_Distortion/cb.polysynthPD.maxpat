...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 22.399999999999999, 80.0, 20.0 ],
					"text" : "PolysynthPD"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 102.0, 36.0, 22.0 ],
					"text" : "pack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 132.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 200.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 48.0, 162.0, 117.0, 22.0 ],
					"text" : "poly~ cb.kinkpoly~ 8"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 72.0, 53.0, 22.0 ],
					"text" : "notein"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cb.kinkpoly~.maxpat",
				"bootpath" : "~/Desktop/Max_System/Libraries/lib_Phase_Distortion",
				"patcherrelativepath" : "../Desktop/Max_System/Libraries/lib_Phase_Distortion",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
