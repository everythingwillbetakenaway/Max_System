...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.5, 466.5, 63.0, 16.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 10.5, 441.0, 32.5, 18.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.5, 280.0, 62.0, 18.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 146.0, 280.0, 62.0, 18.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 86.5, 348.0, 73.0, 18.0 ],
					"text" : "comb~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.0, 269.0, 37.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 154.75, 149.0, 60.0, 37.0 ],
					"text" : "delay time "
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 238.0, 269.0, 58.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 154.75, 186.0, 58.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 5.5, 348.0, 73.0, 18.0 ],
					"text" : "comb~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 238.0, 292.0, 44.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 284.3125, 292.0, 57.0, 18.0 ],
					"text" : "feedback"
				}
...
, 			{
				"box" : 				{
					...
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-7", "live.toggle", "float", 1.0, 5, "obj-19", "live.gain~", "float", -6.0, 5, "obj-25", "live.toggle", "float", 1.0, 5, "obj-3", "umenu", "int", 0, 5, "obj-12", "live.dial", "float", 0.966614, 5, "obj-9", "live.numbox", "float", 1.0 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-7", "live.toggle", "float", 1.0, 5, "obj-19", "live.gain~", "float", -6.0, 5, "obj-25", "live.toggle", "float", 1.0, 5, "obj-3", "umenu", "int", 0, 5, "obj-12", "live.dial", "float", 0.966614, 5, "obj-9", "live.numbox", "float", 5.0 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "obj-7", "live.toggle", "float", 1.0, 5, "obj-19", "live.gain~", "float", -6.0, 5, "obj-25", "live.toggle", "float", 1.0, 5, "obj-3", "umenu", "int", 0, 5, "obj-12", "live.dial", "float", 0.966614, 5, "obj-9", "live.numbox", "float", 12.0 ]
						}
, 						{
							"number" : 4,
							"data" : [ 5, "obj-7", "live.toggle", "float", 1.0, 5, "obj-19", "live.gain~", "float", -6.0, 5, "obj-25", "live.toggle", "float", 1.0, 5, "obj-3", "umenu", "int", 0, 5, "obj-12", "live.dial", "float", 0.966614, 5, "obj-9", "live.numbox", "float", 18.0 ]
						}
, 						{
							"number" : 5,
							"data" : [ 5, "obj-7", "live.toggle", "float", 1.0, 5, "obj-19", "live.gain~", "float", -6.0, 5, "obj-25", "live.toggle", "float", 1.0, 5, "obj-3", "umenu", "int", 0, 5, "obj-12", "live.dial", "float", 0.966614, 5, "obj-9", "live.numbox", "float", 25.0 ]
						}
 ]
				}
