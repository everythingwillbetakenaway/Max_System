...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.0, 267.5, 51.0, 37.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.25, 142.0, 51.0, 37.0 ],
					"text" : "depth"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 163.75, 182.0, 44.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_unitstyle" : 1,
							"parameter_mmax" : 1.0,
...
, 						{
							"number" : 4,
							"data" : [ 5, "obj-7", "live.toggle", "float", 1.0, 5, "obj-19", "live.gain~", "float", -5.0, 5, "obj-25", "live.toggle", "float", 1.0, 5, "obj-3", "umenu", "int", 0, 5, "obj-37", "live.numbox", "float", 0.4, 5, "obj-39", "live.dial", "float", 0.905512, 5, "obj-42", "live.numbox", "float", 11025.0, 5, "obj-44", "live.menu", "float", 1.0, 5, "obj-64", "live.dial", "float", 0.779528, 5, "obj-65", "live.dial", "float", -0.631417, 5, "obj-66", "live.numbox", "float", 0.0, 5, "obj-68", "live.numbox", "float", 0.5 ]
						}
, 						{
							"number" : 5,
