...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 90.500031, 118.0, 90.5, 20.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.000031, 195.0, 103.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 130.000031, 264.243774, 21.0, 81.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.000061, 300.243774, 74.0, 18.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 107.000061, 355.243774, 37.0, 20.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 106.000031, 264.243774, 21.0, 81.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.000061, 325.243774, 50.0, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 162.000031, 144.0, 67.0, 20.0 ],
					"text" : "vs.random"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.000031, 169.0, 162.0, 20.0 ],
					"text" : "pack 0 0 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.000031, 224.0, 129.0, 20.0 ],
					"text" : "poly~ p_pantones~ 16"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 37.500061, 359.243774, 94.000061, 359.243774, 94.000061, 350.243774, 116.500061, 350.243774 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 60.500061, 350.243774, 116.500061, 350.243774 ],
					"source" : [ "obj-9", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				"name" : "p_pantones~.maxpat",
				"bootpath" : "/Users/Mau/my workspace/Cartella Lavoro (lite)/ConTempoNet/virtual sound 2.0/Capitoli/Volume II/MESD_ID Midi Preset Strutture Dati/Interludio D patches",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
