...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 64.0, 72.0, 46.0, 22.0 ],
									"text" : "sig~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 64.0, 208.0, 36.0, 20.0 ],
									"text" : "+~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 39.0, 275.0, 75.0, 18.0 ],
									"text" : "Mixed signal"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 208.5, 24.0, 56.0, 18.0 ],
									"text" : "Balance"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 132.0, 24.0, 49.0, 18.0 ],
									"text" : "Input 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 144.0, 160.0, 50.0, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 31.0, 160.0, 35.0, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 224.0, 39.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 24.0, 49.0, 18.0 ],
									"text" : "Input 1"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 1 ],
									"midpoints" : [ 73.5, 147.0, 56.5, 147.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 1 ],
									"midpoints" : [ 153.5, 194.0, 90.5, 194.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 40.5, 193.0, 73.5, 193.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 233.5, 87.0, 119.5, 87.0 ],
									"order" : 1,
									"source" : [ "obj-9", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 1 ],
									"midpoints" : [ 233.5, 111.0, 184.5, 111.0 ],
									"order" : 0,
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 80.0, 248.0, 80.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 141.0, 208.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 114.0, 120.0, 144.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 80.0, 80.0, 144.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 110.5, 168.0, 151.0, 22.0 ],
					"text" : "delay~ 88200 @delay 8nd"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 288.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 16.0, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 89.5, 114.0, 123.5, 114.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 89.5, 150.0, 120.0, 150.0 ],
					"order" : 1,
					"source" : [ "obj-17", 0 ]
				}
