...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 24.0, 83.0, 20.0 ],
					"text" : "delayxfade~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 328.0, 139.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 32.0, 406.0, 43.0, 22.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 64.0, 296.0, 66.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 64.0, 264.0, 32.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 288.0, 201.0, 30.0 ],
					"text" : "Arguments: buffer size in ms, delay time in ms, xfade time in ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 56.0, 315.0, 18.0 ],
					"text" : "xfade between the old delay time and the new delay time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 438.0, 89.0, 18.0 ],
					"text" : "delayed signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 80.0, 100.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 80.0, 99.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 80.0, 73.0, 18.0 ],
					"text" : "input signal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 96.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 272.0, 232.0, 34.0, 20.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 224.0, 160.0, 67.0, 20.0 ],
					"text" : "f #3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 128.0, 146.0, 20.0 ],
					"text" : "t b b f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 192.0, 56.0, 20.0 ],
					"text" : "t i b i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 264.0, 83.0, 20.0 ],
					"text" : "line~ 0."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 64.0, 184.0, 32.5, 20.0 ],
									"text" : "+~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 144.0, 88.0, 54.0, 30.0 ],
									"text" : "arg. 1: balance"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 88.0, 216.0, 77.0, 18.0 ],
									"text" : "Mixed signal"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 160.0, 24.0, 54.0, 18.0 ],
									"text" : "balance"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 64.0, 216.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 96.0, 144.0, 34.5, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 32.0, 144.0, 34.5, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 128.0, 72.0, 51.0, 20.0 ],
									"text" : "+~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 48.0, 112.0, 38.0, 20.0 ],
									"text" : "!-~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 32.0, 24.0, 47.0, 18.0 ],
									"text" : "input 1"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 137.5, 103.0, 57.5, 103.0 ],
									"order" : 1,
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 1 ],
									"midpoints" : [ 137.5, 103.0, 121.0, 103.0 ],
									"order" : 0,
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 1 ],
									"midpoints" : [ 105.5, 174.0, 87.0, 174.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 41.5, 175.0, 73.5, 175.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 32.0, 374.5, 147.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.0, 336.0, 131.0, 20.0 ],
					"text" : "tapout~ #2 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.0, 128.0, 61.0, 20.0 ],
					"text" : "tapin~ #1"
				}
...
, 			{
				"box" : 				{
					"comment" : "(signal) sound to be delayed",
					"id" : "obj-20",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 281.5, 256.0, 120.5, 256.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 188.0, 224.0, 281.5, 224.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 206.5, 224.0, 73.5, 224.0 ],
					"source" : [ "obj-14", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 153.5, 365.0, 105.5, 365.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 120.5, 327.0, 153.5, 327.0 ],
					"source" : [ "obj-24", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 73.5, 327.0, 41.5, 327.0 ],
					"source" : [ "obj-24", 0 ]
				}
