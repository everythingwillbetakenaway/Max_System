...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 272.0, 240.0, 60.0 ],
					"text" : "The envelope follower ramps to the peak amplitude in n samples; once it arrives (or sees a new peak) it forgets the old peak and ramps toward a new peak."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 121.0, 109.0, 20.0 ],
					"text" : "ramp in n samples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.0, 24.0, 109.0, 20.0 ],
					"text" : "ramp in n samples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 312.0, 224.0, 33.0 ],
					"text" : "double-click the buffer~ objects or the capture~ obejcts to see the results"
				}
...
,
					"patching_rect" : [ 176.0, 192.0, 131.0, 22.0 ],
					"text" : "gen~ envelopefollower"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 256.0, 96.0, 22.0 ],
					"text" : "poke~ envelope"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 336.0, 256.0, 85.0, 22.0 ],
					"text" : "poke~ snare"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 464.0, 288.0, 130.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 334.5, 288.0, 111.0, 22.0 ],
					"text" : "buffer~ snare 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 369.0, 216.0, 87.0, 22.0 ],
					"text" : "count~ 0 0 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 64.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 336.0, 64.0, 69.0, 22.0 ],
					"text" : "delay 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 528.0, 24.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.0, 64.0, 130.0, 22.0 ],
					"text" : "prepend rampsamples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 416.0, 104.0, 37.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 640.0, 136.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 464.0, 64.0, 53.0, 22.0 ],
					"text" : "t 1 clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 464.0, 104.0, 195.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 184.0, 94.0, 22.0 ],
					"text" : "capture~ f 4410"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 184.0, 101.0, 22.0 ],
					"text" : "capture~ f 44100"
				}
...
,
					"patching_rect" : [ 464.0, 144.0, 131.0, 22.0 ],
					"text" : "gen~ envelopefollower"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 96.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 16.0, 64.0, 63.0, 22.0 ],
					"text" : "delay 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 96.0, 63.0, 22.0 ],
					"text" : "t 1 b clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 80.0, 24.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 176.0, 120.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 152.0, 130.0, 22.0 ],
					"text" : "prepend rampsamples"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 152.0, 41.0, 22.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 232.0, 94.0, 22.0 ],
					"text" : "capture~ f 4410"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 232.0, 94.0, 22.0 ],
					"text" : "capture~ f 4410"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 136.0, 37.0, 22.0 ],
					"text" : "dac~"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 473.5, 55.5, 345.5, 55.5 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 649.5, 165.0, 681.0, 165.0, 681.0, 95.0, 425.5, 95.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 89.5, 182.5, 185.5, 182.5 ],
					"order" : 0,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 473.5, 136.0, 361.5, 136.0 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 473.5, 136.0, 345.5, 136.0 ],
					"order" : 2,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 133.5, 223.5, 185.5, 223.5 ],
					"order" : 0,
					"source" : [ "obj-20", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 133.5, 223.5, 89.5, 223.5 ],
					"order" : 1,
					"source" : [ "obj-20", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 111.5, 135.5, 89.5, 135.5 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 89.5, 126.5, 25.5, 126.5 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 537.5, 136.0, 473.5, 136.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 345.5, 96.0, 411.0, 96.0, 411.0, 60.0, 425.5, 60.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 378.5, 246.5, 512.0, 246.5 ],
					"order" : 0,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 507.5, 175.0, 473.5, 175.0 ],
					"order" : 0,
					"source" : [ "obj-9", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-27", 0 ],
					"midpoints" : [ 507.5, 175.0, 361.5, 175.0 ],
					"order" : 1,
					"source" : [ "obj-9", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 473.5, 95.0, 425.5, 95.0 ],
					"order" : 1,
					"source" : [ "obj-9", 0 ]
				}
