...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 624.0, 192.0, 154.0, 20.0 ],
					"text" : "outputs interpolated values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.5, 305.0, 163.0, 20.0 ],
					"text" : "read through in 441 samples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.5, 248.0, 163.0, 20.0 ],
					"text" : "read through in 256 samples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.5, 288.0, 112.0, 20.0 ],
					"text" : "turn MSP on briefly"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.0, 24.0, 189.0, 20.0 ],
					"text" : "synchronizes the phasor~ objects"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 24.0, 104.0, 20.0 ],
					"text" : "start with MSP off"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 48.0, 89.0, 20.0 ],
					"text" : "fills the buffer~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.0, 144.0, 159.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 608.0, 248.0, 50.0, 22.0 ],
					"text" : "sah~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 608.0, 208.0, 101.0, 22.0 ],
					"text" : "wave~ sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 608.0, 280.0, 88.0, 22.0 ],
					"text" : "capture~ f 883"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 608.0, 144.0, 83.0, 22.0 ],
					"text" : "phasor~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 464.0, 248.0, 50.0, 22.0 ],
					"text" : "sah~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 464.0, 208.0, 102.0, 22.0 ],
					"text" : "index~ sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 280.0, 88.0, 22.0 ],
					"text" : "capture~ f 883"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 464.0, 176.0, 46.0, 22.0 ],
					"text" : "*~ 256"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.0, 104.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 528.0, 72.0, 36.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 448.0, 40.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 464.0, 144.0, 83.0, 22.0 ],
					"text" : "phasor~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 64.0, 296.0, 29.5, 22.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 305.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 304.0, 192.0, 50.0, 22.0 ],
					"text" : "sah~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 304.0, 152.0, 102.0, 22.0 ],
					"text" : "index~ sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 304.0, 120.0, 87.0, 22.0 ],
					"text" : "count~ 0 0 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 224.0, 88.0, 22.0 ],
					"text" : "capture~ f 256"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.0, 96.0, 35.0, 22.0 ],
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 64.0, 264.0, 32.0, 22.0 ],
					"text" : "* 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 64.0, 232.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.5, 192.0, 52.5, 22.0 ],
					"text" : "uzi 16 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 64.0, 328.0, 115.0, 22.0 ],
					"text" : "peek~ sequence"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 160.0, 178.0, 22.0 ],
					"text" : "buffer~ sequence @samps 256"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 313.5, 182.5, 344.5, 182.5 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 537.5, 134.5, 681.5, 134.5 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 473.5, 238.5, 504.5, 238.5 ],
					"order" : 0,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 617.5, 238.5, 648.5, 238.5 ],
					"order" : 0,
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 73.5, 222.0, 121.5, 222.0 ],
					"order" : 0,
					"source" : [ "obj-4", 2 ]
				}
