...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 336.0, 104.0, 1479.0, 141.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 24.0, 100.0, 20.0 ],
					"text" : "Sample and hold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.75, 430.0, 175.5, 33.0 ],
					"text" : "eight random frequencies per second, from 440 Hz to 880 Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 155.5, 312.0, 139.0, 20.0 ],
					"text" : "move into desired range"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 240.0, 130.0, 20.0 ],
					"text" : "move into range 0 to 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 145.0, 153.0, 20.0 ],
					"text" : "grab one every 1/8 second"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 144.0, 328.0, 80.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 288.0, 51.0, 22.0 ],
					"text" : "+~ 440."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 216.0, 42.0, 22.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 144.0, 112.0, 64.0, 22.0 ],
					"text" : "phasor~ 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 64.0, 164.0, 20.0 ],
					"text" : "random samples from -1 to 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 328.0, 45.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 144.0, 256.0, 80.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 184.0, 38.0, 22.0 ],
					"text" : "+~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 144.0, 184.0, 80.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 424.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 80.0, 360.0, 136.0, 41.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 89.5, 246.5, 153.5, 246.5 ],
					"order" : 0,
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 89.5, 411.0, 115.5, 411.0 ],
					"order" : 0,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 89.5, 174.5, 153.5, 174.5 ],
					"order" : 0,
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 89.5, 318.5, 153.5, 318.5 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
