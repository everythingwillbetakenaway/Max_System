...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 112.0, 43.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 320.0, 63.0, 20.0 ],
					"text" : "amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 64.0, 65.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 112.0, 96.0, 33.0 ],
					"text" : "-60 or arg 1 = amplitude 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 64.0, 64.5, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 192.0, 32.0, 118.0, 22.0 ],
					"text" : "patcherargs -60. 10."
				}

			}
, 			{
				"box" : 				{
					"comment" : "(float/list) amp in dB",
					"id" : "obj-2",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 64.0, 184.0, 36.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 64.0, 152.0, 51.0, 22.0 ],
					"text" : "<= -60."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 216.0, 32.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 216.0, 41.0, 22.0 ],
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.0, 288.0, 36.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 256.0, 66.0, 22.0 ],
					"text" : "pack 0. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 112.0, 115.0, 22.0 ],
					"text" : "pack 0. 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 192.0, 152.0, 70.0, 22.0 ],
					"text" : "line -60. 10"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 201.5, 61.5, 329.5, 61.5 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 201.5, 61.5, 105.5, 61.5 ],
					"order" : 2,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 201.5, 181.0, 185.0, 181.0, 185.0, 143.0, 73.5, 143.0 ],
					"order" : 1,
					"source" : [ "obj-77", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-77", 0 ],
					"midpoints" : [ 329.5, 144.0, 201.5, 144.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-83", 0 ],
					"midpoints" : [ 73.5, 246.0, 201.5, 246.0 ],
					"source" : [ "obj-93", 0 ]
				}
