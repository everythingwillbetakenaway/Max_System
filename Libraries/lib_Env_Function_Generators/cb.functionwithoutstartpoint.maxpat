...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.333343999999997, 232.0, 64.0, 22.0 ],
					"text" : "route float"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 48.0, 40.5, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 72.0, 96.0, 22.0 ],
					"text" : "setdomain 1000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 157.333344000000011, 264.0, 36.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 344.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 208.0, 40.5, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 2, 47.872340999999999, 1.0, 0, 223.404250999999988, 0.48, 0, 845.744689999999991, 0.413333, 0, 1000.0, 0.0, 2 ],
					"id" : "obj-9",
					"maxclass" : "function",
					"numinlets" : 1,
					"numoutlets" : 4,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 48.0, 112.0, 212.000031000000007, 104.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 208.0, 72.0, 65.0, 22.0 ],
					"text" : "metro 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 64.0, 264.0, 75.0, 22.0 ],
					"text" : "cycle~ 1000"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 169.5, 103.5, 57.5, 103.5 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 73.5, 334.5, 99.5, 334.5 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 166.833344000000011, 294.5, 84.0, 294.5 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 217.5, 103.5, 57.5, 103.5 ],
					"source" : [ "obj-8", 0 ]
				}
