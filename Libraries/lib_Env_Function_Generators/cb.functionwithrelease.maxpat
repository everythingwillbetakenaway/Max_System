...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.0, 351.5, 187.0, 87.0 ],
					"text" : "the note-on (nonzero) velocity triggers the attack and decay portions of the envelope, and the note-off (zero) triggers the 'next' message to continue with the release portion of the envelope"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 273.0, 137.0, 20.0 ],
					"text" : "convert dB to amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 241.0, 109.0, 20.0 ],
					"text" : "map velocity to dB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 272.0, 41.0, 22.0 ],
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 192.0, 488.0, 51.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 176.0, 304.0, 67.0, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.0, 456.0, 36.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 5.0, 1.0, 0, 125.0, 0.5, 2, 250.0, 0.0, 0 ],
					"id" : "obj-28",
					"maxclass" : "function",
					"numinlets" : 1,
					"numoutlets" : 4,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 128.0, 344.0, 211.0, 102.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 240.0, 33.0, 22.0 ],
					"text" : "next"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 209.0, 139.0, 20.0 ],
					"text" : "treat note-offs differently"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 128.0, 208.0, 67.0, 22.0 ],
					"text" : "select 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 240.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 169.0, 211.0, 20.0 ],
					"text" : "limit it to monophonic for this example"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 24.0, 43.0, 22.0 ],
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 96.0, 576.0, 37.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 528.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 541.0, 129.0, 51.0, 20.0 ],
					"text" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 129.0, 36.0, 20.0 ],
					"text" : "pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 96.0, 528.0, 83.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 80.0, 64.0, 432.0, 53.0 ],
					"range" : 61
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 96.0, 488.0, 39.0, 22.0 ],
					"text" : "saw~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 456.0, 34.0, 22.0 ],
					"text" : "mtof"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 201.5, 568.800000071525574, 105.5, 568.800000071525574 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 185.5, 334.5, 137.5, 334.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 233.5, 337.800000131130219, 351.0, 337.800000131130219, 351.0, 481.00000011920929, 233.5, 481.00000011920929 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 121.5, 200.100000023841858, 137.5, 200.100000023841858 ],
					"source" : [ "obj-18", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"midpoints" : [ 101.5, 54.5, 502.5, 54.5 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 201.5, 520.900000035762787, 169.5, 520.900000035762787 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 502.5, 160.599999904632568, 121.5, 160.599999904632568 ],
					"source" : [ "obj-8", 0 ]
				}
