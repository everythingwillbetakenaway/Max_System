...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.0, 48.0, 46.0, 20.0 ],
					"text" : "rewind"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 416.0, 16.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 160.0, 48.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 48.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-12",
					"items" : [ "1n", ",", "2n", ",", "2nt", ",", "4n", ",", 384, "ticks", ",", "4nt", ",", 274.286000000000001, "ticks", ",", "8n", ",", 192, "ticks", ",", "8nt", ",", 137.143000000000001, "ticks", ",", "16n", ",", 96, "ticks", ",", "16nt", ",", 68.572000000000003, "ticks", ",", "32n", ",", "32nt" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 120.0, 34.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 208.0, 48.0, 192.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 160.0, 88.0, 275.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 217.5, 78.5, 169.5, 78.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 184.5, 296.0, 136.0, 296.0 ],
					"source" : [ "obj-8", 1 ]
				}
