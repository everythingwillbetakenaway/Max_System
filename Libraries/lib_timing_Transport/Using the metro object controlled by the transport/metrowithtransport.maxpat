...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 24.0, 128.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 224.0, 24.0, 128.0, 20.0 ],
					"text" : "Metro with transport"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 136.0, 35.0, 22.0 ],
					"text" : "b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 461.0, 61.0, 22.0 ],
					"text" : "1 0 0 16n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 399.875, 520.0, 99.125, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 480.0, 488.0, 36.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 224.0, 64.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 64.0, 85.0, 22.0 ],
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 128.0, 64.0, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 304.0, 135.0, 33.0 ],
					"text" : "after downbeat of m. 5, play every 16th note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.875, 432.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 399.875, 464.0, 70.5, 49.0 ],
					"text" : "sfplay~ @audiofile cym.aiff"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 177.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 336.0, 96.0, 140.0, 20.0 ],
					"text" : "bang on every 16th note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 296.0, 71.0, 49.0 ],
					"text" : "if $i2 >= 5 && $i1 != 0 then bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 461.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 128.0, 493.0, 69.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 141.5, 261.0, 128.0, 33.0 ],
					"text" : "starting in measure 3, bang on every offbeat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 360.0, 101.0, 33.0 ],
					"text" : "bang every beat, on the beat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 560.0, 37.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 507.0, 82.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 224.0, 392.0, 99.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 488.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 224.0, 520.0, 165.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 128.0, 296.0, 144.0, 62.0 ],
					"text" : "metro @interval 4n @quantize 8n @autostart 1 @autostarttime 3.1.240"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 41.0, 86.0, 47.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 163.0, 136.0, 47.0, 20.0 ],
					"text" : "Tempo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 104.0, 53.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 152.0, 53.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 136.0, 61.0, 22.0 ],
					"text" : "tempo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 240.0, 38.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 333.0, 208.0, 38.0, 20.0 ],
					"text" : "ticks"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 423.5, 240.0, 35.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 270.5, 208.0, 35.0, 20.0 ],
					"text" : "beat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 240.0, 57.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 195.5, 208.0, 57.0, 20.0 ],
					"text" : "measure"
				}
...
, 			{
				"box" : 				{
					...
					"outputmode" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 128.0, 104.0, 64.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 256.0, 152.0, 64.0, 22.0 ],
					"rounded" : 8.0,
					"text" : "Start",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 224.0, 104.0, 64.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 352.0, 152.0, 64.0, 22.0 ],
					"rounded" : 8.0,
					"text" : "Rewind",
					"texton" : "Rewind"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 352.0, 112.0, 99.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 256.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 416.0, 256.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 263.0, 224.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 352.0, 256.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 199.0, 224.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 352.0, 176.0, 39.0, 22.0 ],
					"text" : "when"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 128.0, 224.0, 131.0, 22.0 ],
					"text" : "transport"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 409.375, 551.0, 251.5, 551.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 249.5, 214.0, 296.0, 214.0, 296.0, 256.0, 137.5, 256.0 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 233.5, 170.5, 361.5, 170.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 41.5, 167.5, 137.5, 167.5 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 1 ],
					"midpoints" : [ 233.5, 552.0, 251.5, 552.0 ],
					"order" : 0,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 41.5, 550.5, 233.5, 550.5 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 137.5, 550.5, 233.5, 550.5 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 489.5, 352.0, 409.375, 352.0 ],
					"order" : 1,
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 361.5, 287.0, 541.5, 287.0 ],
					"source" : [ "obj-5", 0 ]
				}
