...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 781.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.5, 384.0, 176.0, 20.0 ],
					"text" : "independent of global transport"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 351.5, 640.5, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 640.5, 65.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 608.0, 114.5, 87.0 ],
					"text" : "left outlet is always ms, but you can specify desired format for timing info coming out right outlet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 604.0, 123.0, 150.0, 47.0 ],
					"text" : "always on when transport is on, always snapped to the nearest 16th note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.0, 181.0, 166.0, 20.0 ],
					"text" : "start/stop the global transport"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 281.0, 200.0, 33.0 ],
					"text" : "e.g., rewind \"slowtempo\" transport, start it, start metro associated with it"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 432.0, 32.5, 22.0 ],
					"text" : "8n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 432.0, 32.5, 22.0 ],
					"text" : "4n"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 490.5, 259.0, 33.0 ],
					"text" : "quarter note, quintuplet quarter, dotted eighth, eighth, triplet eighth, sixteenth (same as 16n)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 463.0, 215.0, 20.0 ],
					"text" : "various ways to specify a time interval:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 558.0, 259.0, 33.0 ],
					"text" : "here we're measuring the time elapsed between one metro bang and the previous one"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 536.0, 246.0, 20.0 ],
					"text" : "timer measures the time between two bangs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.5, 660.5, 150.0, 33.0 ],
					"text" : "time between events, in terms of \"slowtempo\" time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 660.5, 150.0, 33.0 ],
					"text" : "time between events, in terms of the global time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 448.0, 150.0, 47.0 ],
					"text" : "timing objects associated with that name use that transport for their timing"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 352.0, 178.5, 33.0 ],
					"text" : "you can have a separate timekeeper by giving it a name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.5, 640.5, 113.0, 22.0 ],
					"text" : "120."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 640.5, 96.0, 22.0 ],
					"text" : "250."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 32.0, 608.0, 176.0, 22.0 ],
					"text" : "timer @format ticks"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 93.0, 184.0, 60.0 ],
					"text" : "The transport can act as the global timekeeper for timing objects such as metro, delay, pipe, makenote, etc."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 234.5, 143.0, 33.0 ],
					"text" : "and cause something to happen at that moment"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 351.5, 608.0, 241.0, 22.0 ],
					"text" : "timer @transport slowtempo @format ticks"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 240.0, 25.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 160.0, 129.0, 33.0 ],
					"text" : "you can look for exact moments in time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 105.0, 242.0, 20.0 ],
					"text" : "this just reports transport time once per 16n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 32.0, 192.0, 89.0, 22.0 ],
					"text" : "timepoint 9.1.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 335.5, 328.0, 52.0, 22.0 ],
					"text" : "select 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 288.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.5, 355.0, 32.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 588.0, 195.0, 46.0, 20.0 ],
					"text" : "rewind"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.0, 195.0, 27.0, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 432.0, 31.0, 22.0 ],
					"text" : "8nd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 413.0, 432.0, 27.0, 22.0 ],
					"text" : "8nt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 256.0, 432.0, 58.0, 22.0 ],
					"text" : "384 ticks"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.0, 432.0, 51.0, 22.0 ],
					"text" : "0.0.120"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 111.5, 384.0, 243.0, 22.0 ],
					"text" : "transport @name slowtempo @tempo 48"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 32.0, 496.0, 195.0, 22.0 ],
					"text" : "metro 4n @transport slowtempo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 369.0, 181.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 401.0, 123.0, 206.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 433.0, 155.0, 61.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 187.0, 61.0, 22.0 ],
					"text" : "tempo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.0, 275.0, 48.0, 22.0 ],
					"text" : "4 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 529.0, 275.0, 48.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 464.5, 275.0, 45.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 401.0, 275.0, 48.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 337.0, 275.0, 48.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "int", "int", "float", "float", "float", "", "int", "float", "" ],
					"patching_rect" : [ 401.0, 235.0, 179.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 410.5, 264.0, 346.5, 264.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 430.5, 267.0, 410.5, 267.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 450.5, 269.0, 474.0, 269.0 ],
					"source" : [ "obj-2", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 490.5, 269.0, 538.5, 269.0 ],
					"source" : [ "obj-2", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 510.5, 263.0, 631.5, 263.0 ],
					"source" : [ "obj-2", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 442.5, 219.5, 410.5, 219.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 378.5, 219.5, 410.5, 219.5 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 595.0, 583.0, 595.0 ],
					"order" : 0,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 595.0, 361.0, 595.0 ],
					"order" : 1,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 595.0, 198.5, 595.0 ],
					"order" : 2,
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 454.5, 463.5, 217.5, 463.5 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 1 ],
					"midpoints" : [ 265.5, 463.5, 217.5, 463.5 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 1 ],
					"midpoints" : [ 422.5, 463.5, 217.5, 463.5 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 1 ],
					"midpoints" : [ 329.5, 463.5, 217.5, 463.5 ],
					"source" : [ "obj-53", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 1 ],
					"midpoints" : [ 377.5, 463.5, 217.5, 463.5 ],
					"source" : [ "obj-69", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 322.0, 345.0, 322.0 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 41.5, 322.0, 121.0, 322.0 ],
					"order" : 1,
					"source" : [ "obj-9", 0 ]
				}
